...
def ask_player():
    while True:
        choice = input("Would you like to be X or O (X will always go first)? ").strip().upper()
        if choice == "X" or choice == "O":
            return choice
        else:
            print("Please enter either X or O!")

human_choice = ask_player()
if human_choice == "X":
    human_player = 1
else:
    human_player = 2
        ...
        if self.turn == 1:
            ...
            while True:
                ...
                try:
                    ...
                    if len(parts) != 2:
                        raise ValueError("Need two numbers that are separated by a comma.")
                    r = int(parts[0])
                    c = int(parts[1])

                    if not (0 <= r <= 2 and 0 <= c <= 2):
                        print("Please choose a number between 0 and 2 for both row and column.")
                        continue
                    ...
                    print("Invalid input. Please choose a space like 1,2.")
            ...
            print("AI chooses move: ", best_action, " with score: ")
